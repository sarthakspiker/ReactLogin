...
export default class ClientLoginEmail extends Component <{ showSigninPage: any }, {}>{

  render() {
    return (
      <div className="container-fluid text-center " style={{ margin: '2% auto' }} >
        <img className="card-top" src={New} alt="Card image cap" />
        <h2 ><img className="greentick" src={Tick} alt="Card image cap" style={{ display: 'inline' }} /> Login email sent !</h2>
        <h5>Login using the link in your inbox.</h5>
        <p className="card-text center-center account_text">Please check your mailbox to find the login link</p>
